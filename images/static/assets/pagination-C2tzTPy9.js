var g=Object.defineProperty;var l=(i,e,t)=>e in i?g(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var a=(i,e,t)=>l(i,typeof e!="symbol"?e+"":e,t);class P{constructor(e){a(this,"container");a(this,"totalItems");a(this,"itemsPerPage");a(this,"currentPage");a(this,"onPageChange");a(this,"totalPages");this.container=e.container,this.totalItems=e.totalItems,this.itemsPerPage=e.itemsPerPage,this.currentPage=e.initialPage??0,this.onPageChange=e.onPageChange,this.totalPages=e.totalPages,this.render()}setPage(e){var n;const t=this.getTotalPages(),s=Math.max(0,Math.min(e,t-1));s!==this.currentPage&&(this.currentPage=s,this.render(),(n=this.onPageChange)==null||n.call(this,this.currentPage))}nextPage(){console.log("Going to next page",this.currentPage+1),this.setPage(this.currentPage+1)}prevPage(){console.log("Going to previous page",this.currentPage-1),this.setPage(this.currentPage-1)}getCurrentPage(){return this.currentPage}update(e){console.log("Updating pagination props:",e),typeof e.totalItems=="number"&&(this.totalItems=e.totalItems),typeof e.itemsPerPage=="number"&&(this.itemsPerPage=e.itemsPerPage),e.onPageChange&&(this.onPageChange=e.onPageChange),typeof e.initialPage=="number"&&(this.currentPage=e.initialPage),typeof e.totalPages=="number"&&(this.totalPages=e.totalPages),this.render()}getTotalPages(){return typeof this.totalPages=="number"?Math.max(0,this.totalPages):this.itemsPerPage<=0?0:Math.ceil(this.totalItems/this.itemsPerPage)}render(){const e=this.getTotalPages(),t=this.currentPage*this.itemsPerPage,s=Math.min(t+this.itemsPerPage,this.totalItems);this.container.classList.remove("hidden"),this.container.innerHTML=`
    ...
    `;const n=this.container.querySelector("#prev-page-btn"),r=this.container.querySelector("#next-page-btn");n==null||n.addEventListener("click",o=>{o.preventDefault(),this.prevPage()}),r==null||r.addEventListener("click",o=>{o.preventDefault(),this.nextPage()})}}export{P};
