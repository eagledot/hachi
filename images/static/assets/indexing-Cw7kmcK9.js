var m=Object.defineProperty;var b=(n,e,t)=>e in n?m(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var i=(n,e,t)=>b(n,typeof e!="symbol"?e+"":e,t);import{e as d,f as c,h as v,L as x,C as y}from"./utils-BLLb_BoN.js";/* empty css              */class f{static async getRemoteClients(){try{console.log("Getting remote Clients info: ");const e=await fetch(d.GET_REMOTE_CLIENTS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getting Remote Clients:",e),[]}}static async getPartitions(){try{const e=await c(d.GET_PARTITIONS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getPartitions:",e),[]}}static async getSuggestionPath(e){try{const t=await c(d.GET_SUGGESTION_PATH,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok)throw new Error(`Error fetching suggestion path: ${t.statusText}`);return await t.json()}catch(t){return console.error("Error in getSuggestionPath:",t),[]}}}class w{constructor(e,t={}){i(this,"container");i(this,"currentPath",[]);i(this,"currentDrive",null);i(this,"searchQuery","");i(this,"sortOrder","asc");i(this,"options");i(this,"isLoading",!1);i(this,"availableDrives",[]);i(this,"isDriveSelectionMode",!0);i(this,"currentFolders",[]);this.container=document.getElementById(e),this.options={showOkButton:!0,showCancelButton:!0,title:"Select Folder",drives:[],...t},this.availableDrives=this.options.drives||[],this.render(),this.loadDrives()}async fetchFolders(e){this.searchQuery="",this.clearSearchInput();try{return(await f.getSuggestionPath(e)).filter(o=>!/\.[a-zA-Z0-9]+$/.test(o)).map(o=>({name:o,type:"folder"}))}catch(t){return console.error("Error fetching folders:",t),[]}}clearSearchInput(){const e=this.container.querySelector("#search-input");e&&(e.value="")}render(){this.container.innerHTML=v`
      <div
    ...
    `}}const g=new Set;let u=!1;function S(){u||(u=!0,queueMicrotask(()=>{u=!1;const n=Array.from(g);g.clear();for(const e of n)e()}))}function k(n){g.add(n),S()}class L{constructor(e){i(this,"_value");i(this,"listeners",new Set);this._value=e}get value(){return this._value}set value(e){if(this._value!==e){this._value=e;for(const t of this.listeners)k(t)}}subscribe(e){return this.listeners.add(e),e(this._value),()=>{this.listeners.delete(e)}}}function h(n,e){const t=e.map(s=>s.subscribe(n));return()=>{t.forEach(s=>s())}}const C={isIndexing:!1,isCancelling:!1,indexProgress:0,extraDetails:"",eta:0,uri:[],location:"",identifier:"",completeRescan:!1,selectedProtocol:"none",error:null,simulateIndexing:!1,remote_client_id:null};class E{constructor(e){i(this,"state",new L({...C}));i(this,"root");i(this,"apiUrl");i(this,"pollingTimeout",null);i(this,"pageLoaded",!0);i(this,"partitions",[]);i(this,"folderSelector",null);i(this,"subscriptions",[]);i(this,"refs",{});this.root=e.root,this.apiUrl=e.apiUrl,this.render(),this.cacheDomRefs(),this.setupReactiveSystem(),this.updateSelectedPathDisplay(""),this.pollIndexStatus(this.pageLoaded),f.getRemoteClients().then(t=>{let s=document.getElementById("protocol-select");for(;s!=null&&s.firstChild&&s.children.length!=1;)s.lastChild&&s.removeChild(s.lastChild);if(s)for(let o=0;o<t.length;o=o+1){let r=document.createElement("option");r.value=t[o].protocol,r.id=t[o].id,r.innerText="☁️"+t[o].name+" "+t[o].id,s.appendChild(r)}else console.error("I guess not rendered yet Document!!")}),f.getPartitions().then(t=>{this.partitions=t}).catch(t=>{console.error("Error fetching partitions:",t)})}setState(e){this.state.value={...this.state.value,...e}}hasValidSelection(){const{identifier:e,selectedProtocol:t}=this.state.value;return e!==""&&e!=="none"&&(t==="none"||t!=="none")}cacheDomRefs(){this.refs={protocolSelect:this.root.querySelector("#protocol-select"),rescanCheckbox:this.root.querySelector("#complete-rescan"),browseBtn:this.root.querySelector("#browse-btn"),simulateIndexingCheckbox:this.root.querySelector("#simulate-indexing"),scanBtn:this.root.querySelector("#scan-btn"),cancelBtn:this.root.querySelector("#cancel-btn"),advancedToggle:this.root.querySelector("#advanced-toggle"),advancedOptions:this.root.querySelector("#advanced-options"),advancedChevron:this.root.querySelector("#advanced-chevron")}}setupReactiveSystem(){this.subscriptions.push(h(this.updateActionButtons.bind(this),[this.state]),h(this.updateProgressSection.bind(this),[this.state]),h(this.updateErrorSection.bind(this),[this.state]),h(this.updateInputsState.bind(this),[this.state]))}render(){this.root.innerHTML="";const e=document.createElement("div");e.className="bg-white rounded-lg shadow-md p-6 border border-gray-200 w-full max-w-2xl mx-auto",e.innerHTML=v`
    ...
    `,document.body.appendChild(t),this.cacheDomRefs(),this.attachEvents()}updateProgressSection(){var a;const{isIndexing:e,indexProgress:t,eta:s,extraDetails:o}=this.state.value,r=this.root.querySelector(".bg-blue-50");if(e){const l=`
      ...
      `;if(r)r.outerHTML=l;else{const p=(a=this.root.querySelector("select"))==null?void 0:a.parentElement;p&&p.insertAdjacentHTML("afterend",l)}}else r&&r.remove()}updateErrorSection(){const{error:e}=this.state.value,t=this.root.querySelector(".bg-red-50");if(e){const s=`
