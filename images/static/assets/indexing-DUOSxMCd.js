var b=Object.defineProperty;var m=(n,e,t)=>e in n?b(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var r=(n,e,t)=>m(n,typeof e!="symbol"?e+"":e,t);import{f as d,e as c,h as p,L as x,C as y}from"./utils-BSuwgFyC.js";/* empty css              */class v{static async getPartitions(){try{const e=await d(c.GET_PARTITIONS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getPartitions:",e),[]}}static async getSuggestionPath(e){try{const t=await d(c.GET_SUGGESTION_PATH,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok)throw new Error(`Error fetching suggestion path: ${t.statusText}`);return await t.json()}catch(t){return console.error("Error in getSuggestionPath:",t),[]}}}class S{constructor(e,t={}){r(this,"container");r(this,"currentPath",[]);r(this,"currentDrive",null);r(this,"searchQuery","");r(this,"sortOrder","asc");r(this,"options");r(this,"isLoading",!1);r(this,"availableDrives",[]);r(this,"isDriveSelectionMode",!0);r(this,"currentFolders",[]);this.container=document.getElementById(e),this.options={showOkButton:!0,showCancelButton:!0,title:"Select Folder",drives:[],...t},this.availableDrives=this.options.drives||[],this.render(),this.loadDrives()}async fetchFolders(e){this.searchQuery="",this.clearSearchInput();try{return(await v.getSuggestionPath(e)).filter(o=>!/\.[a-zA-Z0-9]+$/.test(o)).map(o=>({name:o,type:"folder"}))}catch(t){return console.error("Error fetching folders:",t),[]}}clearSearchInput(){const e=this.container.querySelector("#search-input");e&&(e.value="")}render(){this.container.innerHTML=p`
      <div
    ...
    `}}const f=new Set;let u=!1;function w(){u||(u=!0,queueMicrotask(()=>{u=!1;const n=Array.from(f);f.clear();for(const e of n)e()}))}function k(n){f.add(n),w()}class L{constructor(e){r(this,"_value");r(this,"listeners",new Set);this._value=e}get value(){return this._value}set value(e){if(this._value!==e){this._value=e;for(const t of this.listeners)k(t)}}subscribe(e){return this.listeners.add(e),e(this._value),()=>{this.listeners.delete(e)}}}function h(n,e){const t=e.map(s=>s.subscribe(n));return()=>{t.forEach(s=>s())}}const C={isIndexing:!1,isCancelling:!1,indexProgress:0,extraDetails:"",eta:0,uri:[],location:"",identifier:"",completeRescan:!1,selectedProtocol:"none",error:null,simulateIndexing:!1};class E{constructor(e){r(this,"state",new L({...C}));r(this,"root");r(this,"apiUrl");r(this,"pollingTimeout",null);r(this,"pageLoaded",!0);r(this,"partitions",[]);r(this,"folderSelector",null);r(this,"subscriptions",[]);r(this,"refs",{});this.root=e.root,this.apiUrl=e.apiUrl,this.render(),this.cacheDomRefs(),this.setupReactiveSystem(),this.updateSelectedPathDisplay(""),this.pollIndexStatus(this.pageLoaded),v.getPartitions().then(t=>{this.partitions=t}).catch(t=>{console.error("Error fetching partitions:",t)})}setState(e){this.state.value={...this.state.value,...e}}hasValidSelection(){const{identifier:e,selectedProtocol:t}=this.state.value;return e!==""&&e!=="none"&&(t==="none"||t!=="none")}cacheDomRefs(){this.refs={protocolSelect:this.root.querySelector("#protocol-select"),rescanCheckbox:this.root.querySelector("#complete-rescan"),browseBtn:this.root.querySelector("#browse-btn"),simulateIndexingCheckbox:this.root.querySelector("#simulate-indexing"),scanBtn:this.root.querySelector("#scan-btn"),cancelBtn:this.root.querySelector("#cancel-btn"),advancedToggle:this.root.querySelector("#advanced-toggle"),advancedOptions:this.root.querySelector("#advanced-options"),advancedChevron:this.root.querySelector("#advanced-chevron")}}setupReactiveSystem(){this.subscriptions.push(h(this.updateActionButtons.bind(this),[this.state]),h(this.updateProgressSection.bind(this),[this.state]),h(this.updateErrorSection.bind(this),[this.state]),h(this.updateInputsState.bind(this),[this.state]))}render(){this.root.innerHTML="";const e=document.createElement("div");e.className="bg-white rounded-lg shadow-md p-6 border border-gray-200 w-full max-w-2xl mx-auto",e.innerHTML=p`
    ...
    `,document.body.appendChild(t),this.cacheDomRefs(),this.attachEvents()}updateProgressSection(){var a;const{isIndexing:e,indexProgress:t,eta:s,extraDetails:o}=this.state.value,i=this.root.querySelector(".bg-blue-50");if(e){const l=`
      ...
      `;if(i)i.outerHTML=l;else{const g=(a=this.root.querySelector("select"))==null?void 0:a.parentElement;g&&g.insertAdjacentHTML("afterend",l)}}else i&&i.remove()}updateErrorSection(){const{error:e}=this.state.value,t=this.root.querySelector(".bg-red-50");if(e){const s=`
