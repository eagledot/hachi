var m=Object.defineProperty;var b=(n,e,t)=>e in n?m(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var i=(n,e,t)=>b(n,typeof e!="symbol"?e+"":e,t);import{e as d,f as c,h as v,L as x,C as y}from"./layout-BImXdik9.js";/* empty css              */class f{static async getRemoteClients(){try{console.log("Getting remote Clients info: ");const e=await fetch(d.GET_REMOTE_CLIENTS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getting Remote Clients:",e),[]}}static async getPartitions(){try{const e=await c(d.GET_PARTITIONS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getPartitions:",e),[]}}static async getSuggestionPath(e){try{const t=await c(d.GET_SUGGESTION_PATH,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok)throw new Error(`Error fetching suggestion path: ${t.statusText}`);return await t.json()}catch(t){return console.error("Error in getSuggestionPath:",t),[]}}}class S{constructor(e,t={}){i(this,"container");i(this,"currentPath",[]);i(this,"currentDrive",null);i(this,"searchQuery","");i(this,"sortOrder","asc");i(this,"options");i(this,"isLoading",!1);i(this,"availableDrives",[]);i(this,"isDriveSelectionMode",!0);i(this,"currentFolders",[]);this.container=document.getElementById(e),this.options={showOkButton:!0,showCancelButton:!0,title:"Select Folder",drives:[],...t},this.availableDrives=this.options.drives||[],this.render(),this.loadDrives()}async fetchFolders(e){this.searchQuery="",this.clearSearchInput();try{return(await f.getSuggestionPath(e)).filter(o=>!/\.[a-zA-Z0-9]+$/.test(o)).map(o=>({name:o,type:"folder"}))}catch(t){return console.error("Error fetching folders:",t),[]}}clearSearchInput(){const e=this.container.querySelector("#search-input");e&&(e.value="")}render(){this.container.innerHTML=v`
      <div
