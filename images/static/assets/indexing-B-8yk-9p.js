var v=Object.defineProperty;var b=(n,e,t)=>e in n?v(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var r=(n,e,t)=>b(n,typeof e!="symbol"?e+"":e,t);import{e as d,L as m,C as x}from"./config-BqZhBBhP.js";/* empty css              */import{h as g}from"./utils-DPM9xUNI.js";class p{static async getPartitions(){try{const e=await fetch(d.GET_PARTITIONS);if(!e.ok)throw new Error(`Error fetching partitions: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error in getPartitions:",e),[]}}static async getSuggestionPath(e){try{const t=await fetch(d.GET_SUGGESTION_PATH,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok)throw new Error(`Error fetching suggestion path: ${t.statusText}`);return await t.json()}catch(t){return console.error("Error in getSuggestionPath:",t),[]}}}class y{constructor(e,t={}){r(this,"container");r(this,"currentPath",[]);r(this,"currentDrive",null);r(this,"searchQuery","");r(this,"sortOrder","asc");r(this,"options");r(this,"isLoading",!1);r(this,"availableDrives",[]);r(this,"isDriveSelectionMode",!0);r(this,"currentFolders",[]);this.container=document.getElementById(e),this.options={showOkButton:!0,showCancelButton:!0,title:"Select Folder",drives:[],...t},this.availableDrives=this.options.drives||[],this.render(),this.loadDrives()}async fetchFolders(e){this.searchQuery="",this.clearSearchInput();try{return(await p.getSuggestionPath(e)).filter(o=>!/\.[a-zA-Z0-9]+$/.test(o)).map(o=>({name:o,type:"folder"}))}catch(t){return console.error("Error fetching folders:",t),[]}}clearSearchInput(){const e=this.container.querySelector("#search-input");e&&(e.value="")}render(){this.container.innerHTML=g`
    ...
    `}}const u=new Set;let h=!1;function S(){h||(h=!0,queueMicrotask(()=>{h=!1;const n=Array.from(u);u.clear();for(const e of n)e()}))}function w(n){u.add(n),S()}class k{constructor(e){r(this,"_value");r(this,"listeners",new Set);this._value=e}get value(){return this._value}set value(e){if(this._value!==e){this._value=e;for(const t of this.listeners)w(t)}}subscribe(e){return this.listeners.add(e),e(),()=>{this.listeners.delete(e)}}}function c(n,e){const t=e.map(s=>s.subscribe(n));return()=>{t.forEach(s=>s())}}const L={isIndexing:!1,isCancelling:!1,indexProgress:0,extraDetails:"",eta:0,uri:[],location:"",identifier:"",completeRescan:!1,selectedProtocol:"none",error:null,simulateIndexing:!1};class C{constructor(e){r(this,"state",new k({...L}));r(this,"root");r(this,"apiUrl");r(this,"pollingTimeout",null);r(this,"pageLoaded",!0);r(this,"partitions",[]);r(this,"folderSelector",null);r(this,"subscriptions",[]);r(this,"refs",{});this.root=e.root,this.apiUrl=e.apiUrl,this.render(),this.cacheDomRefs(),this.setupReactiveSystem(),this.updateSelectedPathDisplay(""),this.pollIndexStatus(this.pageLoaded),p.getPartitions().then(t=>{this.partitions=t}).catch(t=>{console.error("Error fetching partitions:",t)})}setState(e){this.state.value={...this.state.value,...e}}hasValidSelection(){const{identifier:e,selectedProtocol:t}=this.state.value;return e!==""&&e!=="none"&&(t==="none"||t!=="none")}cacheDomRefs(){this.refs={protocolSelect:this.root.querySelector("#protocol-select"),rescanCheckbox:this.root.querySelector("#complete-rescan"),browseBtn:this.root.querySelector("#browse-btn"),simulateIndexingCheckbox:this.root.querySelector("#simulate-indexing"),scanBtn:this.root.querySelector("#scan-btn"),cancelBtn:this.root.querySelector("#cancel-btn"),advancedToggle:this.root.querySelector("#advanced-toggle"),advancedOptions:this.root.querySelector("#advanced-options"),advancedChevron:this.root.querySelector("#advanced-chevron")}}setupReactiveSystem(){this.subscriptions.push(c(this.updateActionButtons.bind(this),[this.state]),c(this.updateProgressSection.bind(this),[this.state]),c(this.updateErrorSection.bind(this),[this.state]),c(this.updateInputsState.bind(this),[this.state]))}render(){this.root.innerHTML="";const e=document.createElement("div");e.className="bg-white rounded-lg shadow-md p-6 border border-gray-200 w-full max-w-2xl mx-auto",e.innerHTML=g`
    ...
    `,document.body.appendChild(t),this.cacheDomRefs(),this.attachEvents()}updateProgressSection(){var a;const{isIndexing:e,indexProgress:t,eta:s,extraDetails:o}=this.state.value,i=this.root.querySelector(".bg-blue-50");if(e){const l=`
      ...
      `;if(i)i.outerHTML=l;else{const f=(a=this.root.querySelector("select"))==null?void 0:a.parentElement;f&&f.insertAdjacentHTML("afterend",l)}}else i&&i.remove()}updateErrorSection(){const{error:e}=this.state.value,t=this.root.querySelector(".bg-red-50");if(e){const s=`
